...
const COMMANDMENTS = [
  ...
  { roman: 'XIII',  title: 'NAME YOUR FEARS — OR THEY WILL BLIND YOU',          tag: 'PSYCHOLOGY', body: 'Losing money and being proven wrong sit at the top of your fear list. Say them out loud before the market opens. An unnamed fear controls you from the shadows — and it narrows your entire vision to that single point of dread, blinding you to every other possibility. Name it. Step back. Widen your view. Then decide.' },
  ...
  { roman: 'XXII',  title: 'EACH CANDLE IS A VERDICT',                          tag: 'EXECUTION',  body: 'At every candle close, stop and ask: is my edge still here? Has the market structure changed? Am I still in the trade I entered — or has something shifted beneath me? Your original analysis was a hypothesis. Each candle is the market\'s answer to it. If the answer contradicts your thesis, exit. Do not hold what the market is actively disproving.' },
  // RULE
